...
class ModelHelper():
    ...
    __goalkeeper_v2_folder_name = "goalkeeper_v2"
    ...
    __latest_goalkeeper_v2_datetime_folder_name = "2024_5_20_11_49_6"
    ...
    @staticmethod
    def get_goalkeeper_v2_model():
        return ModelHelper.get_model_by_relative_path(
            ModelHelper.__goalkeeper_v2_folder_name,
            ModelHelper.__latest_goalkeeper_v2_datetime_folder_name)
    
    @staticmethod
    def get_defensor_model():
        return ModelHelper.get_model_by_relative_path(
            ModelHelper.__defensor_folder_name,
            ModelHelper.__latest_defensor_datetime_folder_name)
